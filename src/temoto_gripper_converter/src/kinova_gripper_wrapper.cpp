		...
		temoto_robot_manager::GripperControl::Response& res)
{
	...
	goal.fingers.finger1 = float(req.position)/100 * FINGER_MAX;
	goal.fingers.finger2 = float(req.position)/100 * FINGER_MAX;
	goal.fingers.finger3 = float(req.position)/100 * FINGER_MAX;
